  ...
  <div class="wrap">
    ...
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        ...
        <tr valign="top"><th scope="row"><?php _e('Add custom google font?', 'roots'); ?></th>
          <td>
            <fieldset>
              <legend class="screen-reader-text"><span><?php _e('Add google font?', 'roots'); ?></span></legend>
              <input type="text" name="roots_theme_activation_options[custom_google_font]" id="custom_google_font">
              <p class="description"><?php printf(__('Add custom google font \'the default font is Lato \'', 'roots')); ?></p>
            </fieldset>
          </td>
        </tr>
      </table>
...
//	google font
  if (($roots_theme_activation_options['custom_google_font'])=='') {
	//define('GOOGLE_FONTS','xx'); 
	 // global $google_font;
	  //$google_font=$roots_theme_activation_options['add_custom_google_font'];
     $roots_theme_activation_options['custom_google_font'] = false;
//	  $google_font = $roots_theme_activation_options['add_custom_google_font'];
//	  $GLOBALS['GOOGLE_FONTS']=$roots_theme_activation_options['add_custom_google_font'] ;
	  //echo $roots_theme_activation_options['add_custom_google_font'];
//	define('GOOGLE_FONTS',$roots_theme_activation_options['add_custom_google_font']); 
