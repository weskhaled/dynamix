...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 class Skyrocket_Image_Checkbox_Custom_Control extends WP_Customize_Control {
 		 ...
 		 */
  		public function enqueue() {
 			wp_enqueue_style( 'skyrocket-custom-controls-css', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
  		}
 		/**
	...
	class Skyrocket_Single_Accordion_Custom_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
	...
	class Skyrocket_Slider_Custom_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css',  trailingslashit(get_template_directory_uri()). '../app/lib/customizer-custom-controls/css/customizer.css', array(), '1.0', 'all' );
	...
	class Skyrocket_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'skyrocket-custom-controls-js', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/js/customizer.js', array( 'skyrocket-select2-js' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/css/customizer.css', array(), '1.1', 'all' );
	...
	class Skyrocket_Customize_Alpha_Color_Control extends WP_Customize_Control {
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', trailingslashit( get_template_directory_uri() ) . '../app/lib/customizer-custom-controls/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
